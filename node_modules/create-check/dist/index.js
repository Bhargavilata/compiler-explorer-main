...
var _a = env_ci_1.default(), isCi = _a.isCi, env = __rest(_a, ["isCi"]);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    jwt = app.getSignedJsonWebToken();
                    appOctokit = new rest_1.Octokit({ auth: jwt, baseUrl: baseUrl });
                ...
                case 3:
                    token = _d.sent();
                    return [2 /*return*/, new rest_1.Octokit({ auth: token, baseUrl: baseUrl })];
            }
        });
    });
}
...
function createCheck(_a) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        var baseUrl, app, HEAD, PRE_HEAD, appInfo, _c, err, octokit, summary, _d, first, rest, _e, _f, owner, _g, repo, check, run;
        var _this = this;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 5:
                    ...
                    return [4 /*yield*/, octokit.checks
                            .create(check)
                            .catch(function () { return octokit.checks.create(__assign(__assign({}, check), { head_sha: PRE_HEAD })); })];
                case 6:
                    run = _h.sent();
