...
function () {
  ...
  _createClass(CMAdapter, [{
    ...
    value: function indentLine(line) {
      ...
      editor.executeCommands("editor.action.".concat(indentRight ? 'indent' : 'outdent', "Lines"), _cursorTypeOperations.TypeOperations[indentRight ? 'indent' : 'outdent'](cursorConfig, this.editor.getModel(), [sel]));
    }
  }, {
    key: "setStatusBar",
